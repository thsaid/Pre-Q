...
```{r}
PALSfit <- cfa(latents.model, data = PALS)
summary(PALSfit) #to view summary of the fit
partable(PALSfit) # to have the summary converted to a dataframe
```


#INSTRUCT Micro-tutorial
For the sake of this tutorial, I will create some dummy variables
